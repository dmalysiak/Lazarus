/*
 * ClusterNodeManagementWorkerThread.cpp
 *
 *  Created on: 12.06.2013
 *      Author: darius
 */

#include "ClusterNodeManagementWorkerThread.h"
#include "../../Protocols/ClusterLib/ClusterLibNodeManagementFrameHandler.h"
#include "../../Protocols/ClusterLib/ClusterLibFrameAssembler.h"

namespace Lazarus
{

ClusterNodeManagementWorkerThread::ClusterNodeManagementWorkerThread(unsigned int max_connections,
...
ClusterNodeManagementWorkerThread::~ClusterNodeManagementWorkerThread() {
	// TODO Auto-generated destructor stub
}

void ClusterNodeManagementWorkerThread::addConnection(TCPSocket* tcpsocket)
{
	...
	TCPConnection* connection = new TCPConnection(0,m_epoll_in_fd,mp_active_in_events, DEFAULT_RECEIVE_BUFFER_SIZE,
			DEFAULT_SEND_BUFFER_SIZE, ClusterNodeManagementWorkerThread::MAX_EPOLL_EVENTS,2);
	...
	ClusterLibNodeManagementFrameHandler* frame_handler = new ClusterLibNodeManagementFrameHandler(connection,mp_cn_node_facility);
	...
	/*unsigned int type_size = sizeof(ClusterNodeManagementServer::CLUSTERNODE_MANAGEMENT_REQUEST_TYPE);
	ClusterLibFrame frame(connection);
	ClusterNodeManagementServer::CLUSTERNODE_MANAGEMENT_REQUEST_TYPE type =
			ClusterNodeManagementServer::CLUSTERNODE_MANAGEMENT_REQUEST_TYPE_PING;
