/*
 * WhirlpoolHashFunction.h
 *
 *  Created on: 15.12.2014
 *      Author: Darius Malysiak
 */

#ifndef WHIRLPOOLHASH_H_
#define WHIRLPOOLHASH_H_

#include "HashFunction.h"

namespace Lazarus {

class WhirlpoolHashFunction: public HashFunction {
public:
	WhirlpoolHashFunction();
	virtual ~WhirlpoolHashFunction();
